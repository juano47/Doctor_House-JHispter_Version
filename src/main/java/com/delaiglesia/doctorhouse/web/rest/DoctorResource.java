...
import com.delaiglesia.doctorhouse.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.delaiglesia.doctorhouse.domain.Doctor}.
 */
@RestController
@RequestMapping("/api")
