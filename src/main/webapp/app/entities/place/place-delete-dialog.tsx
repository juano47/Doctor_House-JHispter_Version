...
export const PlaceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doctorHouseJHipsterVersionApp.place.delete.question">
        <Translate contentKey="doctorHouseJHipsterVersionApp.place.delete.question" interpolate={{ id: placeEntity.id }}>
