...
export const DoctorDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doctorHouseJHipsterVersionApp.doctor.delete.question">
        <Translate contentKey="doctorHouseJHipsterVersionApp.doctor.delete.question" interpolate={{ id: doctorEntity.id }}>
